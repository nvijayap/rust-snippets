...
It lets you handle situations where data might be borrowed or owned, and it only clones (copies) the data into a new, owned memory block if you actually try to change it.
```
